...
"[project]/src/entities/ad/api/useAd.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const useAd = (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'ad',
            id
        ],
        queryFn: async ()=>{
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(`/ads/${id}`);
            return res.data;
        },
        enabled: !!id
    });
...
"[project]/src/app/ads/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$entities$2f$ad$2f$api$2f$useAd$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/entities/ad/api/useAd.ts [app-ssr] (ecmascript)");
...
function AdPage() {
    ...
    const id = params.id;
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$entities$2f$ad$2f$api$2f$useAd$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAd"])(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9bef0cef._.js.map